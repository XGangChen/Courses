...
env = gym.make('CustomFrozenLake-v1', desc=None, map_name="8x8", is_slippery=False, render_mode='human')
...
def run_demo(policy_net, num_episodes=1):
    ...
    demo_env = gym.make('CustomFrozenLake-v1', desc=None, map_name="8x8", is_slippery=False, render_mode='human')
